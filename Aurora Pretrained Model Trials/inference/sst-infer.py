...
ax[0].set_title("Aurora Prediction (2 m T, 12:00 UTC)")
ax[0].set_xticks([])
ax[0].set_yticks([])

# --- ERA5 SST (K → °C)
ax[1].imshow(sst_ds["sst"][0].values - 273.15, vmin=-50, vmax=50)
ax[1].set_title("ERA5 Sea Surface Temperature (12:00 UTC)")
ax[1].set_xticks([])
ax[1].set_yticks([])
...
# Save the output
output_filename = "aurora_vs_era5_12UTC.png"
