...
download_path = Path("/home/mridul01/scratch/era5-data")
...
# Save the output figure to the current working directory
output_filename = f"aurora_prediction_{datetime.datetime.now().strftime('%Y%m%d%H%M%S')}.png"
